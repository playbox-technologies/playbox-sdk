...
{
    public class FacebookSdkService : PlayboxService
    {
        public override void Initialization()
        {
            base.Initialization();

            PbProxyClass.OnPauseStatusChanged += OnApplicationPause;
            PbProxyClass.OnFocusStatusChanged += OnApplicationFocus;
            
            ServiceType = ServiceType.Facebook;
            
            FacebookSdkConfiguration.LoadJsonConfig();
            
            if(!FacebookSdkConfiguration.FacebookSDKData.active)
                return;
            
            Debug.Log(FacebookSdkConfiguration.FacebookSDKData.active);
